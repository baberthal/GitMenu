...
@property (nullable, nonatomic, retain) id repoURL;
@property (nullable, nonatomic, retain) id repoGitDirectoryURL;
@property (nullable, nonatomic, retain) NSString *displayPath;
@property (nullable, nonatomic, retain) NSString *displayGitDirectoryPath;
...
- (void)replaceRepoGroupsAtIndexes:(NSIndexSet *)indexes withRepoGroups:(NSArray<GMURepoGroup *> *)values;
